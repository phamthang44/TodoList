...
<html lang="en">
  ...
  <body>
    <% String id_raw = request.getParameter("todolist_id"); int todoId =
    Integer.parseInt(id_raw); %>
    <h2>Tasks list</h2>
    ...
    <script>
      ...
      document.getElementById("homeButton").onclick = function () {
          ...
          window.location.href =
                  contextPath + "/home?todolist_id=" + id;
      };
      ...
      form.onsubmit = function (e) {
          errorMsg.textContent = validate(inputTitleElement, inputDescElement);
          if (errorMsg.textContent || !inputDescElement.value || !inputTitleElement.value) {
              errorMsg.classList.add("invalid");
